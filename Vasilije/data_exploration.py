...
def read_dataset():
    ...
    train = pd.read_csv(DS_PATH + "/train.csv")
...
def plot_image_binary(image_id):
    """
    Ploting protein image in binary form for all four color filters
